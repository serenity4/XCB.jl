...
xcb_headers = [joinpath.(Ref(xcb_include_dir), ["xkb.h"])..., joinpath(xcb_util_keysims_dir, "xcb_keysyms.h"), joinpath(xcb_util_dir, "xcb_event.h")]

# Set up include paths
clang_xcb_includes = [xcb_include_dir, xcb_util_keysims_dir, xcb_util_dir]
...
wc_xcb = init(;
                        ...
                        header_library=x -> basename(x) == "xcb_keysyms.h" ? "libxcb_keysyms" : basename(x) == "xkb.h" ? "libxcb_xkb" : basename(x) == "xcb_event.h" ? "libxcb_util" : "libxcb",
